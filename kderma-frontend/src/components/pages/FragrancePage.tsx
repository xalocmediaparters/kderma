...
const FragrancePage: React.FC = () => {
  ...
  const [selectedCategory, setSelectedCategory] = useState<string>('Fragrance');
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Captivating scents to express your personality
          </p>
        </div>
        ...
        <div className="mb-8">
          <div className="flex flex-wrap justify-center gap-4 mb-6">
            <Button
              variant={selectedCategory === 'Fragrance' ? "primary" : "outline"}
              onClick={() => {
            ...
            {NAVIGATION_ITEMS.categories.filter(cat => cat !== 'Fragrance').map(category => (
              <Button
                key={category}
