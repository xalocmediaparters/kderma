      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Exclusive deals and special offers on our products
          </p>
        </div>
        ...
        <div className="mb-8">
          <div className="flex flex-wrap justify-center gap-4 mb-6">
            <Button
              variant={selectedCategory === 'Offers' ? "primary" : "outline"}
              onClick={() => {
            ...
            {NAVIGATION_ITEMS.categories.filter(cat => cat !== 'Offers').map(category => (
              <Button
                key={category}
